...
public abstract class ShovelItemMixin extends MiningToolItem implements DoublePickaxeShovelTool {
    ...
    public boolean postMine(ItemStack stack, World world, BlockState state, BlockPos pos, LivingEntity miner) {
        return use(super.postMine(stack, world, state, pos, miner), stack, world, state, pos, miner, ShovelItem.class);
    }
}
