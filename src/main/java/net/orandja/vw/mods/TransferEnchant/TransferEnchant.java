package net.orandja.vw.mods.TransferEnchant;
...
import net.orandja.mcutils.Settings;
...
//        public boolean getBookAndTool(QuadConsumer<ItemStack, ItemStack, Integer, Integer> consumer) {
